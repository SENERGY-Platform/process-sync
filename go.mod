...
require (
	...
	github.com/SENERGY-Platform/event-deployment v0.0.15
	github.com/SENERGY-Platform/event-worker v1.0.17
	...
	github.com/SENERGY-Platform/process-deployment v0.0.10

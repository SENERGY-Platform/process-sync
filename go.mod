...
require (
	...
	github.com/SENERGY-Platform/device-repository v0.2.36
	github.com/SENERGY-Platform/event-deployment v0.0.40
	github.com/SENERGY-Platform/event-worker v1.0.41
	...
	github.com/SENERGY-Platform/process-deployment v0.0.21

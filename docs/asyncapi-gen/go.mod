...
require (
	...
	github.com/SENERGY-Platform/event-deployment v0.0.40 // indirect
	github.com/SENERGY-Platform/event-worker v1.0.41 // indirect
	...
	github.com/SENERGY-Platform/process-deployment v0.0.21 // indirect
